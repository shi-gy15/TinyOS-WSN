...
public class JChart {
    ...
    public void makeLineAndShapeChart() {
        double[][] data = new double[][]{
                {672, 766, 223, 540, 126, 325, 521, 210, 340, 106, 332, 256, 523, 240, 526,
                        672, 766, 223, 540, 126, 325, 521, 210, 340, 106, 332, 256, 523, 240, 526,
                        672, 766, 223, 540, 126, 325, 521, 210, 340, 106, 332, 256, 523, 240, 526}
        };
        String[] rowKeys = {"temperature"};
        String[] columnKeys = new String[data[0].length];
        for (int i = 0; i < data[0].length; i++) {
            columnKeys[i] = "" + i;
        }
        CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
        createTimeXYChar("chart", "time", "temperature", dataset, "lineAndShap.png");
    }
